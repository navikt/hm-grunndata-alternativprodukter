...
class FileImportServiceTest(
    ...
    fun `importNewFiles should import new files and store handled filename`() {
        ...
        runBlocking {
            ...
            fileImportHistoryRepository.findAll().toList().size shouldBe 37
            ...
            hmsArtnrMappingRepository.findBySourceHmsArtnr("233032").size shouldBe 3
            hmsArtnrMappingRepository.findBySourceHmsArtnr("256775").size shouldBe 3
            ...
            hmsArtnrMappingRepository.findBySourceHmsArtnr("238378").size shouldBe 2
            hmsArtnrMappingRepository.findBySourceHmsArtnr("203491").size shouldBe 4
            ...
            hmsArtnrMappingRepository.findBySourceHmsArtnr("286892").size shouldBe 4
            ...
            hmsArtnrMappingRepository.findBySourceHmsArtnr("230747").size shouldBe 4
            ...
            hmsArtnrMappingRepository.findBySourceHmsArtnr("327635").size shouldBe 1
            ...
            hmsArtnrMappingRepository.findBySourceHmsArtnr("161977").size shouldBe 4
            hmsArtnrMappingRepository.findBySourceHmsArtnr("248358").size shouldBe 16
